<div class="row my-4 rounded-0">
    <div class="col rounded-0">
        <div class="accordion rounded-0" id="collapsibleSection">
            <!-- Delivery Address -->
            <div class="card accordion-item  rounded-0">
                <h2 class="accordion-header" id="headingDeliveryAddress">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseDeliveryAddress" aria-expanded="true"
                        aria-controls="collapseDeliveryAddress">Geral
                    </button>
                </h2>
                <div id="collapseDeliveryAddress" class="accordion-collapse collapse show rounded-0"
                        ...
                        <form>
                            <div class="accordion-body rounded-0">
                                <div class="row rounded-0">
                                    <div class="col-12 col-md-12 col-xl-12 rounded-0">
                                        ...
                                        <div class="row rounded-0">
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="mb-3">
                                                    <label class="form-label">Código ISO 3166</label>
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control " placeholder="<aputo" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="mb-3">
                                                    <label class="form-label">Cidade Mas Populosa</label>
                                                    <input type="text" class="form-control "
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="mb-3">
                                                    <label class="form-label">Internet TLD</label>
                                                    <input type="text" class="form-control "
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="mb-3">
                                                    <label class="form-label">Código de chamada</label>
                                                    <input type="text" class="form-control "
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="mb-3">
                                                    <label class="form-label">Lado de condução</label>
                                                    <input type="text" class="form-control "
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="mb-3">
                                                    <label class="form-label">Lingua Ofcial</label>
                                                    <input type="text" class="form-control "
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
            ...
            <div class="card accordion-item">
                <h2 class="accordion-header" id="headingDeliveryOptions">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        aria-controls="collapseDeliveryOptions"> Politica
                    </button>
                </h2>
                                    ...
                                    <div class="col-12 col-md-12 col-xl-12">
                                        <div class="row rounded-0">
                                            <div class="col-12 col-md-3">
                                                <div class="mb-4">
                                                    <label class="form-label">Governo</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Republica Unitaria semipresidencialista sob um sistema de parido dominante" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-3">
                                                <div class="mb-4">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <div class="mb-4">
                                                    <label class="form-label">Primeiro-ministro</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-3">
                                                <div class="mb-4">
                                                    <label class="form-label">Independência de Portugal</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-3">
                                                <div class="mb-4">
                                                    <label class="form-label">Guerra Civil Moçambicana</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-3">
                                                <div class="mb-4">
                                                    <label class="form-label">Constituição atual</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="John Doe" />
                                                </div>
                                            </div>
            ...
            <div class="card accordion-item">
                <h2 class="accordion-header" id="headingPaymentMethod">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        aria-controls="collapsePaymentMethod"> Economico
                    </button>
                </h2>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-8 col-xl-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                <label class="form-label" for="collapsible-payment-expiry-date">Exp.
                                                    Date</label>
