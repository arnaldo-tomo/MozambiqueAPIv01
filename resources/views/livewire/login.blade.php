<div>
    ...
    <head>
        ...
        <!-- Vendor -->
        <link rel="stylesheet" href="admin/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
                ...
                <div class="authentication-inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- /Logo -->
                            <h4 class="mb-2">Tela de login! 👋</h4>
                            <p class="mb-4">Descricao de como usar,tamben nem faz sentido isso e para admin so</p>
@if (session('status'))
...
@endif
                            <form  class="mb-3" wire:submit.prevent="login">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" wire:model='email'
                                        placeholder="Email e admin@gmail.com" autofocus>
                                        @error('email')
        ...
        <!-- Vendors JS -->
        <script src="admin/vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
        <script src="admin/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
        <script src="admin/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>
