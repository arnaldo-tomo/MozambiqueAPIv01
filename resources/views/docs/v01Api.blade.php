...
<div class="col mb-4">
	...
	<div class="callout-block callout-block-info">
		<div class="content">
			<h4 class="callout-title">
				...
				<code><code>https://mocambiqueApi/docs/v01/bancos{code}</code> </code>
			</h4>
		</div>
	</div>
	...
	<h6>Reponses samples</h6>
	<h5><code class="bg-info text-white">200</code> <code class="bg-danger text-white">500</code></h5>
	<div class="docs-code-block">
	<pre class="shadow-lg rounded"><code class="json hljs">[
  {
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingThree">
      <button class="accordion-button bg-danger text-white collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
       404 nao encontrado
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingfoo">
      <button class="accordion-button collapsed bg-danger text-white" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefoo" aria-expanded="false" aria-controls="flush-collapsefoo">
