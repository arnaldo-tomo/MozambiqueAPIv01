(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [179], {
        ...
        4465: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.addLocale = void 0, r(2700);
            let n = function (e) {
                for (var t = arguments.length, r = Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++) r[n - 1] = arguments[n];
                return e
            };
            t.addLocale = n, ("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
                value: !0
            }), Object.assign(t.default, t), e.exports = t.default)
        },
        4643: function (e, t) {
        ...
        4534: function (e, t, r) {
            ...
            let F = S.default();
            t.emitter = F;
            let H = e => [].slice.call(e),
                q = !1;
            self.__next_require__ = r;
            class W extends _.default.Component {
                componentDidCatch(e, t) {
                    this.props.fn(e, t)
                }
                componentDidMount() {
                    this.scrollToHash(), n.isSsr && "/404" !== a.page && "/_error" !== a.page && (a.isFallback || a.nextExport && (E.isDynamicRoute(n.pathname) || location.search || q) || a.props && a.props.__N_SSG && (location.search || q)) && n.replace(n.pathname + "?" + String(x.assign(x.urlQueryToSearchParams(n.query), new URLSearchParams(location.search))), o, {
                        _h: 1,
                        shallow: !a.isFallback && !q
                    }).catch(e => {
            ...
            function Z() {
                return (Z = g(function* () {
                    ...
                    let e = a.assetPrefix || "";
                    if (r.p = `${e}/_next/`, C.setConfig({
                            serverRuntimeConfig: {},
                            publicRuntimeConfig: a.runtimeConfig || {}
                        }), o = j.getURL(), $.hasBasePath(o) && (o = k.removeBasePath(o)), a.scriptLoader) {
                        let {
                            initScriptLoader: t
                        } = r(3573);
                        t(a.scriptLoader)
            ...
            let V = e => t => {
                ...
                return _.default.createElement(G, null, z(e, r))
            };
            ...
            function X(e) {
                ...
                return console.error(l), console.error("A client-side exception has occurred, see here for more info: https://nextjs.org/docs/messages/client-side-exception-occurred"), i.loadPage("/_error").then(n => {
                    ...
                    return Promise.resolve((null == (i = e.props) ? void 0 : i.err) ? e.props : j.loadGetInitialProps(t, d)).then(t => en(y({}, e, {
                        err: l,
                        Component: s,
                        styleSheets: u,
                        props: t
            ...
            function ee() {
                j.ST && (performance.mark("afterHydrate"), performance.measure("Next.js-before-hydration", "navigationStart", "beforeRender"), performance.measure("Next.js-hydration", "beforeRender", "afterHydrate"), f && performance.getEntriesByName("Next.js-hydration").forEach(f), Q())
            }
            ...
            function en(e) {
                ...
                function p() {
                    ...
                    if (!s) return;
                    let e = H(document.querySelectorAll("style[data-n-href]")),
                ...
                let m = _.default.createElement(_.default.Fragment, null, _.default.createElement(J, {
                    callback: function () {
                        if (s && !f) {
                            ...
                            }), H(document.querySelectorAll("link[data-n-p]")).forEach(e => {
                ...
                }), _.default.createElement(G, null, z(r, d), _.default.createElement(O.Portal, {
                ...
                return ! function (e, t) {
                    ...
                    } else Y = P.default.hydrateRoot(e, r), K = !1
                }(l, e => _.default.createElement(er, {
                    callbacks: [e, p]
                }, _.default.createElement(_.default.StrictMode, null, m))), h
            }
            ...
            function ei() {
                return (ei = g(function* (e) {
                    ...
                    window.__NEXT_PRELOADREADY && (yield window.__NEXT_PRELOADREADY(a.dynamicIds)), t.router = n = T.createRouter(a.page, a.query, o, {
                        ...
                        subscription: (e, t, r) => ea(Object.assign({}, e, {
                            App: t,
                            scroll: r
                        })),
                        locale: a.locale,
                    ...
                    }), q = yield n._initialMatchesMiddlewarePromise;
                    let g = {
                        App: d,
                        initial: !0,
                        Component: h,
                    ...
                    (null == e ? void 0 : e.beforeRender) && (yield e.beforeRender()), ea(g)
                })).apply(this, arguments)
            }("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
                value: !0
            }), Object.assign(t.default, t), e.exports = t.default)
            ...
            t.default = class {
                ...
                getDataHref(e) {
                    ...
                    return (e => {
                        ...
                        return a.addBasePath(`/_next/data/${this.buildId}${t}${h}`, !0)
            ...
            var l = e => {
                if (n = e, !o)
                    for (let t of (o = !0, a)) try {
                        ...
                        console.warn(`Failed to track ${t} web-vital`, s)
                    }
            };
        ...
        8483: function (e, t, r) {
            ...
            let o = {
                ...
                i = () => {
                    let {
                        asPath: e
                    } = a.useRouter(!0), [t, r] = n.default.useState(""), i = n.default.useRef(e);
      ...
      script[src^="${t}"]`;
        ...
        880: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (!t && e) throw Error("invariant expected pages router to be mounted");
                return t
                ...
                u.ready(() => {
                    o.default.events.on(e, function () {
                        ...
                        if (u[a]) try {
                            ...
                            console.error(`Error when running the Router event: ${a}`), console.error(l.default(o) ? `${o.message}
${o.stack}` : o + "")
                        }
                    })
                })
            ...
            function y(e) {
                ...
                if (s.useEffect(() => {
                    ...
                    if ("beforeInteractive" === c) return r ? (l.default.preload(r, p.integrity ? {
                        ...
                        nonce: P,
                        dangerouslySetInnerHTML: {
                            __html: `(self.__next_s=self.__next_s||[]).push(${JSON.stringify([0,n({},p)])})`
                        }
                    }));
        ...
        67: function (e, t, r) {
            ...
            class c extends(n = o.default.Component) {
                render() {
                    ...
                    return o.default.createElement("div", {
                        style: u.error
                    }, o.default.createElement(i.default, null, o.default.createElement("title", null, e ? `${e}: ${r}` : "Application error: a client-side exception has occurred")), o.default.createElement("div", null, o.default.createElement("style", {
                        dangerouslySetInnerHTML: {
                            __html: `
            ...
            c.displayName = "ErrorPage", c.getInitialProps = s, c.origGetInitialProps = s, t.default = c
        },
        610: function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
        ...
        3121: function (e, t, r) {
            ...
            t.default = p, ("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
                value: !0
            }), Object.assign(t.default, t), e.exports = t.default)
        },
        8914: function (e, t, r) {
        ...
        1003: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.matchesMiddleware = T, t.isLocalURL = $, t.interpolateAs = D, t.resolveHref = B, t.createKey = V, t.default = void 0;
            var n = r(932).Z,
                a = r(6495).Z,
                o = r(2648).Z,
                i = r(1598).Z,
            ...
            function D(e, t, r) {
                ...
                return l.every(e => {
                    let t = i[e] || "",
                        ...
                        l = `[${r?"...":""}${e}]`;
                    return a && (l = `${t?"":"/"}[${l}]`), r && !Array.isArray(t) && (t = [t]), (a || e in i) && (n = n.replace(l, r ? t.map(e => encodeURIComponent(e)).join("/") : encodeURIComponent(t)) || "/")
                }) || (n = ""), {
                    params: l,
                    result: n
                }
            ...
            function B(e, t, r) {
                ...
                let a = "string" == typeof t ? t : b.formatWithValidation(t),
                    ...
                    s = i.split("?");
                if ((s[0] || "").match(/(\/\/|\\)/)) {
                    console.error(`Invalid href passed to next/router: ${a}, repeated forward-slashes (//) or backslashes \\ are not valid in the href`);
                        ...
                        let h = v.searchParamsToUrlQuery(d.searchParams),
                            {
                                result: p,
                                params: y
                            } = D(d.pathname, d.pathname, h);
                        p && (f = b.formatWithValidation({
                            pathname: p,
                            hash: d.hash,
                            query: k(h, y)
                        }))
            ...
            function U(e, t, r) {
                let [n, a] = B(e, t, !0), o = m.getLocationOrigin(), i = n.startsWith(o), l = a && a.startsWith(o);
                n = N(n), a = a ? N(a) : a;
            ...
            let H = "scrollRestoration" in window.history && !! function () {
                    try {
                        let e = "__next";
            ...
            function X(e) {
                ...
                if (t === C.addBasePath(w.addLocale(r.asPath, r.locale))) throw Error(`Invariant: attempted to hard navigate to the same URL ${t} ${location.href}`);
            ...
            class Y {
                ...
                change(e, t, r, o, i) {
                    ...
                    return n(function* () {
                        ...
                        l._inFlightRoute && l.clc && (R || Y.events.emit("routeChangeError", L(), l._inFlightRoute, B), l.clc(), l.clc = null), r = C.addBasePath(w.addLocale(j.hasBasePath(r) ? x.removeBasePath(r) : r, o.locale, l.defaultLocale));
                        let H = E.removeLocale(j.hasBasePath(r) ? x.removeBasePath(r) : r, v.locale);
                        l._inFlightRoute = r;
                        let W = A !== v.locale;
                        if (!h && l.onlyAHashChange(H) && !W) {
                            v.asPath = H, Y.events.emit("hashChangeStart", r, B), l.changeState(e, t, r, a({}, o, {
                                scroll: !1
                            })), N && l.scrollToHash(H);
                            try {
                                yield l.set(v, l.components[v.route], null)
                            } catch (Z) {
                                throw d.default(Z) && Z.cancelled && Y.events.emit("routeChangeError", Z, H, B), Z
                            }
                            return Y.events.emit("hashChangeComplete", r, B), !0
                        }
                        ...
                        if (o.shallow && Q && (G = l.pathname), h && Q && (p = !1), p && "/_error" !== G && (o._shouldResolveHref = !0, z.pathname = F(G, n), z.pathname === G || (G = z.pathname, z.pathname = C.addBasePath(G), Q || (t = b.formatWithValidation(z)))), !$(r)) return X({
                            url: r,
                            router: l
                        }), !1;
                        K = E.removeLocale(x.removeBasePath(K), v.locale);
                        let ee = s.removeTrailingSlash(G),
                            et = !1;
                        if (g.isDynamicRoute(ee)) {
                            let er = y.parseRelativeUrl(K),
                                en = er.pathname,
                                ea = P.getRouteRegex(ee);
                            et = _.getRouteMatcher(ea)(en);
                            let eo = ee === en,
                                ei = eo ? D(ee, en, V) : {};
                            if (et && (!eo || ei.result)) eo ? r = b.formatWithValidation(Object.assign({}, er, {
                                pathname: ei.result,
                                query: k(V, ei.params)
                            })) : Object.assign(V, et);
                            else {
                                let el = Object.keys(ea.groups).filter(e => !V[e]);
                                if (el.length > 0 && !Q) throw Error((eo ? `The provided \`href\` (${t}) value is missing query values (${el.join(", ")}) to be interpolated properly. ` : `The provided \`as\` value (${en}) is incompatible with the \`href\` value (${ee}). `) + `Read more: https://nextjs.org/docs/messages/${eo?"href-interpolation-failed":"incompatible-href-as"}`)
                            }
                        }
                        h || Y.events.emit("routeChangeStart", r, B);
                        try {
                            var es, eu, ec, ed;
                            ...
                            if ("route" in ef && Q) {
                                ee = G = ef.route || ee, B.shallow || (V = Object.assign({}, ef.query || {}, V));
                                let eh = j.hasBasePath(z.pathname) ? x.removeBasePath(z.pathname) : z.pathname;
                                if (et && G !== eh && Object.keys(et).forEach(e => {
                                        et && V[e] === et[e] && delete V[e]
                                    }), g.isDynamicRoute(G)) {
                                    let ep = !B.shallow && ef.resolvedAs ? ef.resolvedAs : C.addBasePath(w.addLocale(new URL(r, location.href).pathname, v.locale), !0),
                                        em = ep;
                                    j.hasBasePath(em) && (em = x.removeBasePath(em));
                                    let eg = P.getRouteRegex(G),
                                        ey = _.getRouteMatcher(eg)(new URL(em, location.href).pathname);
                                    ey && Object.assign(V, ey)
                                }
                            }
                            if ("type" in ef) {
                                if ("redirect-internal" === ef.type) return l.change(e, ef.newUrl, ef.newAs, o);
                                return X({
                                    url: ef.destination,
                                    router: l
                                }), new Promise(() => {})
                            ...
                            if ((eP || eb) && e_) {
                                if (e_.pageProps && e_.pageProps.__N_REDIRECT) {
                                    ...
                                    if (eE.startsWith("/") && !1 !== e_.pageProps.__N_REDIRECT_BASE_PATH) {
                                        let ex = y.parseRelativeUrl(eE);
                                        ex.pathname = F(ex.pathname, n);
                                        let {
                                            url: eC,
                                            as: ej
                                        } = U(l, eE, eE);
                                ...
                                if (v.isPreview = !!e_.__N_PREVIEW, e_.notFound === q) {
                                    let eO;
                                    try {
                                    ...
                                    if (ef = yield l.getRouteInfo({
                                            ...
                                            locale: v.locale,
                                            isPreview: v.isPreview
                                        }), "type" in ef) throw Error("Unexpected middleware effect on /404")
                                }
                            }
                            Y.events.emit("beforeHistoryChange", r, B), l.changeState(e, t, r, o), h && "/_error" === G && (null == (es = self.__NEXT_DATA__.props) ? void 0 : null == (eu = es.pageProps) ? void 0 : eu.statusCode) === 500 && (null == e_ ? void 0 : e_.pageProps) && (e_.pageProps.statusCode = 500);
                            let eM = o.shallow && v.route === (null != (ec = ef.route) ? ec : ee),
                                ...
                                eI = o._h && !eT && !O && !W && M.compareRouterStates(eL, l.state);
                            if (!eI) {
                                if (yield l.set(eL, ef, eT).catch(e => {
                                        if (e.cancelled) ev = ev || e;
                                        else throw e
                                    }), ev) throw h || Y.events.emit("routeChangeError", ev, H, B), ev;
                                h || Y.events.emit("routeChangeComplete", r, B), eA && /#.+$/.test(r) && l.scrollToHash(r)
                            }
                            return !0
                        } catch (eN) {
                ...
                handleRouteInfoError(e, t, r, a, o, i) {
                    ...
                    return n(function* () {
                        ...
                        if (u.isAssetError(e) || i) throw Y.events.emit("routeChangeError", e, a, o), X({
                            url: a,
                            router: l
                        }), L();
                        try {
                        ...
                        try {
                            ...
                            let $ = !k || "initial" in k ? void 0 : k,
                                ...
                                B = E ? {} : yield(I = {
                                    ...
                                    locale: f,
                                    router: j
                                }, T(I).then(e => e && I.fetchData ? I.fetchData().then(e => (function (e, t, r) {
                                    let n = {
                                    ...
                                    if (!l || i || l.includes("__next_data_catchall") || l.includes("/_error") || l.includes("/404") || (i = l), i) {
                                        if (i.startsWith("/")) {
                                            ...
                                            return Promise.all([r.router.pageLoader.getPageList(), u.getClientBuildManifest()]).then(t => {
                                                ...
                                                if (g.isDynamicRoute(i) || !o && n.includes(h.normalizeLocalePath(x.removeBasePath(i), r.router.locales).pathname)) {
                                                    let l = O.getNextPathnameInfo(y.parseRelativeUrl(e).pathname, {
                                                        parseData: !0
                                                    });
                                                ...
                                                let u = n.includes(f) ? f : F(h.normalizeLocalePath(x.removeBasePath(c.pathname), r.router.locales).pathname, n);
                                                if (g.isDynamicRoute(u)) {
                                                    let p = _.getRouteMatcher(P.getRouteRegex(u))(i);
                                        ...
                                        let p = S.parsePath(e),
                                            m = R.formatNextPathnameInfo(a({}, O.getNextPathnameInfo(p.pathname, {
                                                nextConfig: n,
                                                parseData: !0
                                            }), {
                                    ...
                                    if (v) {
                                        if (v.startsWith("/")) {
                                            let b = S.parsePath(v),
                                                E = R.formatNextPathnameInfo(a({}, O.getNextPathnameInfo(b.pathname, {
                                                    nextConfig: n,
                                                    parseData: !0
                                                }), {
                                                    defaultLocale: r.router.defaultLocale,
                                            ...
                                            return Promise.resolve({
                                                ...
                                                newAs: `${E}${b.query}${b.hash}`,
                                                newUrl: `${E}${b.query}${b.hash}`
                                            })
                                        }
                                        return Promise.resolve({
                                            type: "redirect-external",
                            ...
                            if (E && B && (B.json = self.__NEXT_DATA__.props), N(), (null == B ? void 0 : null == (M = B.effect) ? void 0 : M.type) === "redirect-internal" || (null == B ? void 0 : null == (A = B.effect) ? void 0 : A.type) === "redirect-external") return B.effect;
                            if ((null == B ? void 0 : null == (L = B.effect) ? void 0 : L.type) === "rewrite" && (e = s.removeTrailingSlash(B.effect.resolvedHref), r = B.effect.resolvedHref, o = a({}, o, B.effect.parsedAs.query), l = x.removeBasePath(h.normalizeLocalePath(B.effect.parsedAs.pathname, j.locales).pathname), k = j.components[e], c.shallow && k && j.route === e && !p)) return a({}, k, {
                                route: e
                            });
                            ...
                            let U = $ || (yield j.fetchComponent(e).then(e => ({
                                    Component: e.page,
                                    styleSheets: e.styleSheets,
                                    __N_SSG: e.mod.__N_SSG,
                                    __N_SSP: e.mod.__N_SSP
                                }))),
                                H = U.__N_SSG || U.__N_SSP,
                                {
                                    props: q,
                                    cacheKey: Z
                                } = yield j._getData(n(function* () {
                                    if (H) {
                                        let {
                                            json: e,
                                            cacheKey: t
                                        } = (null == B ? void 0 : B.json) ? B: yield G({
                                            dataHref: j.pageLoader.getDataHref({
                                                href: b.formatWithValidation({
                                                    pathname: r,
                                                    query: o
                                    ...
                                    return {
                                        headers: {},
                                        cacheKey: "",
                                        props: yield j.getInitialProps(U.Component, {
                                            pathname: r,
                                            query: o,
                                            asPath: i,
                                            locale: f,
                            ...
                            return U.__N_SSP && D.dataHref && delete j.sdc[Z], j.isPreview || !U.__N_SSG || E || G(Object.assign({}, D, {
                                isBackground: !0,
                                persistCache: !1,
                                inflightCache: W
                            })).catch(() => {}), q.pageProps = Object.assign({}, q.pageProps), U.props = q, U.route = e, U.query = o, U.resolvedAs = l, j.components[e] = U, U
                        } catch (z) {
                            return j.handleRouteInfoError(d.getProperError(z), r, o, i, c)
                        }
                    })()
                }
                set(e, t, r) {
                ...
                prefetch(e) {
                    ...
                    return n(function* () {
                        ...
                        let n = y.parseRelativeUrl(e),
                            ...
                            l = yield a.pageLoader.getPageList(), u = void 0 !== r.locale ? r.locale || void 0 : a.locale;
                        n.pathname = F(n.pathname, l), g.isDynamicRoute(n.pathname) && (o = n.pathname, n.pathname = o, Object.assign(i, _.getRouteMatcher(P.getRouteRegex(n.pathname))(S.parsePath(t).pathname) || {}), e = b.formatWithValidation(n));
                        let c = s.removeTrailingSlash(o);
                        yield Promise.all([a.pageLoader._isSsg(c).then(n => !!n && G({
                        ...
                        }).then(() => !1)), a.pageLoader[r.priority ? "loadPage" : "prefetch"](c)])
                    })()
                }
                fetchComponent(e) {
                    var t = this;
                ...
                constructor(e, t, r, {
                    ...
                    this.sdc = {}, this.isFirstPopStateEvent = !0, this._key = V(), this.onPopState = e => {
                        let t;
                        let {
                        ...
                        if (H && this._key !== u) {
                            ...
                            try {
                                let d = sessionStorage.getItem("__next_scroll_" + u);
                                t = JSON.parse(d)
                            } catch (f) {
                                t = {
                                    x: 0,
                        ...
                        (!this.isSsr || l !== C.addBasePath(this.asPath) || h !== C.addBasePath(this.pathname)) && (!this._bps || this._bps(n)) && this.change("replaceState", i, l, Object.assign({}, s, {
                    ...
                    window.addEventListener("popstate", this.onPopState), H && (window.history.scrollRestoration = "manual")
                }
            }
            Y.events = p.default(), t.default = Y
        },
        4441: function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
        ...
        7429: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return (e.buildId || !e.trailingSlash) && (t = n.removeTrailingSlash(t)), e.buildId && (t = o.addPathSuffix(a.addPathPrefix(t, `/_next/data/${e.buildId}`), "/" === e.pathname ? "index.json" : ".json")), t = a.addPathPrefix(t, e.basePath), !e.buildId && e.trailingSlash ? t.endsWith("/") ? t : o.addPathSuffix(t, "/") : n.removeTrailingSlash(t)
            };
            var n = r(12),
                a = r(4135),
                o = r(6074),
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (i && o.pathHasPrefix(u.pathname, i) && (u.pathname = a.removePathPrefix(u.pathname, i), u.basePath = i), !0 === t.parseData && u.pathname.startsWith("/_next/data/") && u.pathname.endsWith(".json")) {
                    let c = u.pathname.replace(/^\/_next\/data\//, "").replace(/\.json$/, "").split("/"),
                        d = c[0];
                    u.pathname = "index" !== c[1] ? `/${c.slice(1).join("/")}` : "/", u.buildId = d
                }
                if (l) {
        ...
        2864: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (d !== r.origin) throw Error(`invariant: invalid relative URL, router received ${e}`);
                return {
                    pathname: i,
            ...
            function l(e) {
                ...
                return {
                    parameterizedRoute: t.map(e => {
                        if (!(e.startsWith("[") && e.endsWith("]"))) return `/${a.escapeStringRegexp(e)}`; {
                            let {
                                key: t,
                                optional: o,
                                repeat: l
                ...
                return {
                    namedParameterizedRoute: n.map(e => {
                        if (!(e.startsWith("[") && e.endsWith("]"))) return `/${a.escapeStringRegexp(e)}`; {
                            ...
                            return (0 === o.length || o.length > 30) && (u = !0), isNaN(parseInt(o.slice(0, 1))) || (u = !0), u && (o = l()), s[o] = t, n ? r ? `(?:/(?<${o}>.+?))?` : `/(?<${o}>.+?)` : `/(?<${o}>[^/]+?)`
                        }
                    }).join(""),
                    routeKeys: s
                }
            ...
            class r {
                ...
                _insert(e, t, n) {
                    ...
                    if (a.startsWith("[") && a.endsWith("]")) {
                        let o = a.slice(1, -1),
                            i = !1;
                        if (o.startsWith("[") && o.endsWith("]") && (o = o.slice(1, -1), i = !0), o.startsWith("...") && (o = o.substring(3), n = !0), o.startsWith("[") || o.endsWith("]")) throw Error(`Segment names may not start or end with extra brackets ('${o}').`);
        ...
        670: function (e, t, r) {
            ...
            function c() {
                return (c = n(function* (e, t) {
                    ...
                    if (r && s(r)) return n;
                    if (!n) {
                        let a = `"${l(e)}.getInitialProps()" should resolve to an object. But found "${n}" instead.`;
                        throw Error(a)
                    }
                    return n
                })).apply(this, arguments)
        ...
        8018: function (e) {
            var t, r, n, a, o, i, l, s, u, c, d, f, h, p, m, g, y, v, _, P, b, S, w, E, x, C, j, O, R, M, A, L, T, I, N, k, $, D, B, U, F, H, q, W, Z, z;
            (t = {}).d = function (e, r) {
                ...
                var n, a = f("INP"),
                    o = function (e) {
                        ...
                        var t = B[Math.min(B.length - 1, Math.floor(D() / 50))];
                ...
                n = m(e, a, r, t.reportAllChanges), i && (i.observe({
                    ...
                    B = [], $ = N(), n = m(e, a = f("INP"), r, t.reportAllChanges)
                }))
            }, q = {}, W = function (e, t) {
                t = t || {};
                var r, n = [2500, 4e3],
